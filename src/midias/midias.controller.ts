...
export class MidiasController {
  ...
  enviar(@Param('imovel_id', ParseIntPipe) imovel_id: number, @UploadedFiles() arquivos: ArquivoMidia[], @Req() requisicao: Requisicao) { return this.midias.enviar(imovel_id, arquivos, requisicao.user); }
