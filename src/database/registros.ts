...
export const entidades = [Corretor, SessaoLogin, TipoImovel, FinalidadeImovel, Caracteristica, ImovelCaracteristica, Imovel, ImovelMidia, Cliente, ParteLocacao, Contrato, Comissao, ParcelaComissao, RegistroPastaDrive];
...
export const migracoes = [...migracoesLegadas, ModeloPortugues1789516800000];
